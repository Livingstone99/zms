    ...
    var locations=[ ['<div class="infobox"><h3 class="title"><a href="#">ZMS IMMO</a></h3><span>Abidjan Cocody Angré les Oscars derrière Gaou Production</span><span>+225 22 42 76 46</span></div>',
    5.3599517,
    -4.0082563,
    2]];
    var map=new google.maps.Map(document.getElementById('map'), {
        ...
        ], center: new google.maps.LatLng(5.3599517, -4.0082563), mapTypeId: google.maps.MapTypeId.ROADMAP
    }
